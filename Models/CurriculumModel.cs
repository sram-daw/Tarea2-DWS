namespace RamiloAlonsoSaraTarea2.Models
{
	public class CurriculumModel
	{
		...
		public CurriculumModel(int id, string foto, string nombre, string titular, string apellido1, string apellido2, string[] experiencia, string[] educacion, string[] habilidades, string[] idiomas, string mail, string linkedin, string github)
		{
			this.id = id;
			this.foto = foto;
			this.nombre = nombre;
		...
		public CurriculumModel crearPerfil1()
		{
			...
			CurriculumModel perfil1 = new CurriculumModel(1, "/img/profileImage.jpg", "Sara", "Web Developer y Comunicadora", "Ramilo", "Alonso", experiencia, educacion, habilidades, idiomas, "sara.ramilo.alonso@ciclosmontecastelo.com", "https://www.linkedin.com/in/sara-ramilo", "https://github.com/sram-daw");
			return perfil1;
		}
